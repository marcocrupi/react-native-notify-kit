import validateIOSInput from 'react-native-notify-kit/src/validators/validateIOSInput';
import { IOSInput } from 'react-native-notify-kit/src/types/NotificationIOS';
