import validateIOSPermissions from 'react-native-notify-kit/src/validators/validateIOSPermissions';
import { IOSNotificationPermissions } from 'react-native-notify-kit/src/types/NotificationIOS';
