...
Defined in: [packages/react-native/src/types/NotificationAndroid.ts:1014](https://github.com/marcocrupi/react-native-notify-kit/blob/main/packages/react-native/src/types/NotificationAndroid.ts#L1014)
...
Defined in: [packages/react-native/src/types/NotificationAndroid.ts:1026](https://github.com/marcocrupi/react-native-notify-kit/blob/main/packages/react-native/src/types/NotificationAndroid.ts#L1026)
