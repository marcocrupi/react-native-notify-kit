...
Defined in: [packages/react-native/src/types/Trigger.ts:57](https://github.com/marcocrupi/react-native-notify-kit/blob/main/packages/react-native/src/types/Trigger.ts#L57)
