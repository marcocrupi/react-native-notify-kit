...
> **getChannel**(`channelId`): `Promise`\<`null` | [`NativeAndroidChannel`](react-native/reference/Interface.NativeAndroidChannel)>
...
`Promise`\<`null` | [`NativeAndroidChannel`](react-native/reference/Interface.NativeAndroidChannel)>
...
> **getChannelGroup**(`channelGroupId`): `Promise`\<`null` | [`NativeAndroidChannelGroup`](react-native/reference/Interface.NativeAndroidChannelGroup)>
...
`Promise`\<`null` | [`NativeAndroidChannelGroup`](react-native/reference/Interface.NativeAndroidChannelGroup)>
...
> **getInitialNotification**(): `Promise`\<`null` | [`InitialNotification`](react-native/reference/Interface.InitialNotification)>
...
`Promise`\<`null` | [`InitialNotification`](react-native/reference/Interface.InitialNotification)>
...
> **handleFcmMessage**(`remoteMessage`): `Promise`\<`null` | `string`>
...
Configures defaults for [handleFcmMessage](react-native/reference/Interface.ModuleWithStatics#handlefcmmessage). Call once at app startup,
