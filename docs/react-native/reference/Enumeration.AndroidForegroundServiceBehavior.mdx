...
DEFAULT   = NotificationCompat.FOREGROUND\_SERVICE\_DEFAULT   (0)
IMMEDIATE = NotificationCompat.FOREGROUND\_SERVICE\_IMMEDIATE (1)
DEFERRED  = NotificationCompat.FOREGROUND\_SERVICE\_DEFERRED  (2)
