...
Open Source - if you wish to improve any of the types, feel free to submit a [Pull Request](https://github.com/marcocrupi/react-native-notify-kit/pulls)
or file an [Issue](https://github.com/marcocrupi/react-native-notify-kit/issues).
