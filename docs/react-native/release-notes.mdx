...
This unreleased maintenance update realigns the library development target and bare React Native smoke app with React Native 0.85.3. It keeps the minimum supported React Native version at >=0.73.0 and remains New Architecture only.
...
- Expo validation for React Native 0.85 should be handled separately with Expo SDK 56 or later.
