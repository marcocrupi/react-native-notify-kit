...
This 10.4.2 patch hardens Expo CNG iOS `NotifyKitNSE` generation. It does not change the public JavaScript API and does not change runtime notification behavior.
...
- Validated the Expo smoke app iOS prebuild and CocoaPods install with RNFirebase, NotifyKit NSE enabled, `ios.useFrameworks` static, correct NSE metadata, and static-frameworks Podfile linkage.
