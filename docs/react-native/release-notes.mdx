...
* **Docs**: new [docs/fcm-mode.md](https://github.com/marcocrupi/react-native-notify-kit/blob/main/docs/fcm-mode.md) — comprehensive FCM Mode guide covering architecture, server SDK reference, client API reference, iOS NSE setup, Android specifics, payload schema, migration from the manual pattern, troubleshooting, and known limitations.
